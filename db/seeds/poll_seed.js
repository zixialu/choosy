...
exports.seed = function(knex, Promise) {
  ...
  function insertPollChoicesVotes(choices, votes) {
    return knex('poll_choices_votes').insert([
      ...
      {vote_id: votes[1].id, poll_choice_id: choices[0].id, rank: 3},
      {vote_id: votes[1].id, poll_choice_id: choices[1].id, rank: 2},
      {vote_id: votes[1].id, poll_choice_id: choices[2].id, rank: 1},
      {vote_id: votes[2].id, poll_choice_id: choices[0].id, rank: 3},
      {vote_id: votes[2].id, poll_choice_id: choices[1].id, rank: 2},
